...
function getScrollContainers(node, options) {
  ...
  // reliable.
  if (!options.verticalScrollContainerClass || node.classList.contains(options.verticalScrollContainerClass)) {
  ...
  if (!options.horizontalScrollContainerClass ||node.classList.contains(options.horizontalScrollContainerClass)) {
